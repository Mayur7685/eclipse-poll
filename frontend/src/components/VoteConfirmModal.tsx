    ...
    >
      <div className="w-full max-w-md pb-8" onClick={e => e.stopPropagation()}>
        ...
        <div className="bg-[#0a0a0a] rounded-2xl shadow-2xl overflow-hidden flex flex-col border border-gray-800/60">
          <h2 className="text-center text-lg font-semibold text-white tracking-tight pt-5 pb-1">
            Vote Confirmation
          </h2>
          {pollTitle && (
            <p className="text-center text-sm text-gray-400 pb-4 px-6 truncate">{pollTitle}</p>
          )}
          ...
          <div className="px-6 flex flex-col">
            ...
            <div className="flex justify-between items-center py-3 border-b border-white/10">
              ...
              <div className="flex items-center gap-1.5">
                <img src="/favicon-32x32.png" alt="Midnight" className="h-3.5 w-auto opacity-60 invert" />
                <span className="text-sm text-white font-medium">Eclipse Poll</span>
              </div>
            </div>

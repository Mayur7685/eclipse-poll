        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4 overflow-y-auto flex-1">
          ...
          <div>
            ...
            <div className="flex items-center gap-1 mb-1.5 border border-gray-200 rounded-lg px-2 py-1 bg-gray-50">
              ...
              <button type="button" onClick={() => insertMarkdown("[", "](url)")} className="p-1.5 rounded hover:bg-gray-200 text-gray-600" title="Link"><svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"/></svg></button>

...
const REQ_ICONS: Record<string, string> = {
  FREE: 'globe', ALLOWLIST: 'list', TOKEN_BALANCE: 'coin', NFT_OWNERSHIP: 'image',
  ONCHAIN_ACTIVITY: 'chain', DOMAIN_OWNERSHIP: 'globe', X_FOLLOW: 'X',
  DISCORD_MEMBER: 'msg', DISCORD_ROLE: 'tag',
}

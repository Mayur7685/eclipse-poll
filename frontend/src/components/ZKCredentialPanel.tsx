...
import { getCredential, getBlockHeight } from '../lib/utils'
      ...
      <div className="px-5 py-4 border-b border-gray-50 flex items-center justify-between gap-3">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-gray-400 mt-0.5">Issued at {credential.issuedAt.toLocaleString() + " (Unix)"}</p>
          </div>
        </div>
    ...
    <div className="border border-[#0070F3] rounded-xl overflow-hidden shadow-sm bg-white">
      <div className="p-8 text-center">
        <div className="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center mx-auto mb-4 border border-blue-100">
          <span className="text-blue-500 font-bold text-sm">ZK</span>
        </div>
      ...
      <div className="bg-[#0070F3] text-white px-5 py-3.5 text-sm font-medium">
        Attestations are issued on Midnight Network. Connect your 1AM wallet to view yours.
      </div>
    </div>
  )

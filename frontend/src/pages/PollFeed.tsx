    ...
    <div className="flex flex-col gap-10">
      ...
      <section className="text-center pt-8 pb-2">
        ...
        <p className="mt-6 text-base text-gray-500 font-medium max-w-md mx-auto leading-relaxed">
          Zero-Knowledge voting on Midnight Network via Compact contracts. Ranked-choice, simple polls, and anonymous surveys — individual responses never revealed.
        </p>
        ...
        <p className="mt-4 text-xs text-gray-400 font-medium">Powered by Midnight Network · Preprod ZK Contract · Zero-Knowledge Proofs</p>
      </section>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center shadow-sm">
            ...
            <p className="text-sm text-gray-500 mb-6 max-w-xs mx-auto">
              {filter === 'surveys'
                ? 'Create an anonymous survey with ZK-proven responses.'
                : filter === 'polls'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {filtered.map(({ community, poll }, idx) => (
              <PollCard key={`${community.community_id}-${poll.poll_id}-${idx}`}
